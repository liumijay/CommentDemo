...
public class EmojiAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        linearLayout.setPadding(ScreenUtil.dip2px(context, 2), ScreenUtil.dip2px(context, 0),
                ScreenUtil.dip2px(context, 2), ScreenUtil.dip2px(context, 18));
            ...
            for (int i = index * showMaxColumns; i < (index + 1) * showMaxColumns; i++) {
                ...
                if (i < list.size()) {
                    ...
                    if (i == pageMaxCount) {
                        ...
                        textViewLayout.width = ScreenUtil.dip2px(context, 28);
                        textViewLayout.height = ScreenUtil.dip2px(context, 23);
